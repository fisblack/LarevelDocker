...
<div class="container-fluid page-backoffice-news&events">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-11 pt-2">
                ...
                <form action="{{ route('backOffice.website.news-and-event.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class=" col-md-5">
                                    <div class="form-group form-group--inline">
                                        <div class='input-group date'>
                                            ...
                                            <input type='text' name="news_events_date" value="{{ old('news_events_date') ? old('news_events_date') : '' }}" placeholder="dd/mm/yyyy" class="form-control" id="datetimepicker1" />
                                ...
                                <div class=" col-md-5">
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <input type="text" class="form-control" name="title_th" id="news-input" placeholder="ชื่อข่าว" value="{{ old('title_th') }}" required>
                                         </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <textarea class="form-control short_description" name="short_description_th" id="detail-news-input" placeholder="รายละเอียด (ไทย)" rows="5" cols="20" >{{ old('short_description_th') }}</textarea>
                                         </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <textarea class="form-control textarea" name="description_th" id="detail-news-input" placeholder="รายละเอียด (ไทย)" rows="5" cols="20" >{{ old('description_th') }}</textarea>
                                         </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class=" col-md-5">
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <input type="text" class="form-control" name="title_en" id="news-input" placeholder="ชื่อข่าว (อังกฤษ)" value="{{ old('title_en') }}" required>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <textarea class="form-control short_description" name="short_description_en" id="detail-news-input" placeholder="Description" rows="5" cols="20" >{{ old('short_description_en') }}</textarea>
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <textarea class="form-control textarea" name="description_en" id="detail-news-input" placeholder="Description" rows="5" cols="20" >{{ old('description_en') }}</textarea>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                                            ...
                                            <fieldset>
                                                <div class="form-group form-group--inline">
                                                    ...
                                                    <div style="padding-top: 20px;">
                                                        <img id='banner-upload' width="100%">
                                                    </div>
                                ...
                                <div class=" col-md-5">
                                    <fieldset>
                                        <div class="form-group form-group--inline">
                                            ...
                                            <label class="switch">
                                                <input {{ old('is_show') ? 'checked' : '' }} data-toggle="toggle" type="checkbox" name="is_show">
                                                <span class="slider">
