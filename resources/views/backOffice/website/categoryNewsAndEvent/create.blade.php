...
<div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-11 pt-2">
                <form action="{{ route('backOffice.website.category-news-and-event.store') }}" method="POST">
                    {!! csrf_field() !!}
                    <!-- START panel-->
                                    ...
                                    <div class="panel-body__block">
                                        <fieldset>
                                            <div class="form-group form-group--inline">
                                                ...
                                                <input type="text" class="form-control" name="name_th" id="name_th" placeholder="ข่าวทั่วไป" value="{{ old('name_th') }}" required>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            <div class="form-group form-group--inline">
                                                <label class="control-label">ชื่อภาษาอังกฤษ</label>
                                                <input type="text" class="form-control" name="name_en" id="name_en" placeholder="News" value="{{ old('name_en') }}" required>
                                            </div>
                                        </fieldset>
