            ...
            <div class="box-result" style="">
                <div class="row">
                    <div class="col-md-6 col-center">
                        <form action="{{ route('backOffice.setting.point.store') }}" method="POST" class="form-horizontal form-points clearfix" role="form">
							{!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="points" placeholder="จำนวนแต้ม" id="input" class="form-control"  required="required" value="{{old('points')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-11 col-sm-8">
                                    <input type="text" name="discount" id="input" class="form-control"  required="required" placeholder="ส่วนลด" value="{{old('discount')}}">
                                </div>
