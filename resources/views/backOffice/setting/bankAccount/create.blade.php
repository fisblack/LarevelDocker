                ...
                <div class="box-result" style="">
                    <div class="row">
                        <div class="col-md-6 col-center">
                            ...
                            <form action="{{action('BackOffice\Setting\BankAccountController@store')}}" method="POST" class="form-horizontal form-bankacc clearfix" role="form" enctype="multipart/form-data">
                                ...
                                <div class="old-bank form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="bank_id" class="form-control" id="bankacc">
                                            ...
                                            <option value="{{$fact_bank->id}}" data-imagesrc="{{asset($fact_bank->logo)}}" data-description="{{$fact_bank->name}}"></option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="account_type" class="form-control" required="required">
                                            ...
                                            <option value="{{ $type }}" @if( old('account_type') === $type) selected @endif>{{ $type }}</option>
                                            @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" placeholder="ชื่อบัญชีธนาคาร" class="form-control"  required="required" value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="account_no" placeholder="เลขบัญชีธนาคาร" class="form-control"  required="required" value="{{ old('account_no') }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="input" class="col-sm-3 control-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="branch" class="form-control"  required="required" placeholder="สาขา" value="{{ old('branch') }}">
                                    </div>
                                </div>
...
@section('script')
    ...
    <script src="{{ asset('js/backOffice/setting/bankAccount/create.js') }}"></script>
    <script>
        $(function() {
            toastr.options = {
                "closeButton": true,
