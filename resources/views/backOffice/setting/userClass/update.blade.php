	            ...
	            <div class="box-result" style="">
	                <div class="row">
	                    <div class="col-md-6 col-center">
	                        <form action="{{ route('backOffice.setting.user-class.update',$UserClass->id) }}" method="POST" class="form-horizontal form-userclass clearfix" role="form">
								{!! csrf_field() !!}
                                {!! method_field('put') !!}
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" value="{{$request->old('name_th',$UserClass->name_th)}}" name="name_th" placeholder="ชื่อ Class" id="input" class="form-control"  required="required">
	                                </div>
	                            </div>
	                            <div class="form-group">
	                                <label for="input" class="col-sm-3 control-label">
	                                ...
	                                <div class="col-sm-9">
	                                    <input type="text" value="{{$request->old('name_en',$UserClass->name_en)}}" name="name_en"  id="input" class="form-control"  required="required" placeholder="Class Name">
	                                </div>
	                            </div>
	                            <div class="form-group">  
                                    <label for="input" class="col-sm-3 control-label">Color</label>
                                    <div class="col-sm-9">
                                        <input type="text" required="required" value="{{$request->old('color',$UserClass->color)}}" name='color' class="complex-colorpicker form-control asColorPicker-input">
                                ...
                                <div class="@if ($errors->has('discount')){{'form-group has-error'}}@else{{'form-group'}}@endif">
                                    ...
                                    <div class="col-sm-6">
										<input type="text" value="{{$request->old('discount',$UserClass->discount)}}" name="discount" id="input" class="form-control"  required="required" placeholder="Discount">
                                    </div>
                                    <div class="col-sm-3">
                                        <select value="{{$request->old('discount_type',$UserClass->discount_type)}}" name="discount_type" class="form-control">
	                            ...
	                            <div class="@if ($errors->has('minimum_purchase')){{'form-group has-error'}}@else{{'form-group'}}@endif">
	                                ...
	                                <div class="col-xs-11 col-sm-3">
	                                    <input type="text" value="{{$request->old('minimum_purchase',$UserClass->minimum_purchase)}}" name="minimum_purchase" id="input" class="form-control"  required="required" placeholder="">
	                                </div>
