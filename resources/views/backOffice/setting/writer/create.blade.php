    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <div class="box-result" style="">
                <div class="row">
                    <div class="col-md-12 ">
                        <form action="{{ route('backOffice.setting.writer.store') }}" method="POST" class="form-horizontal form-writers clearfix" role="form" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="name_th" placeholder="ชื่อ" id="input" class="form-control"  required="required">
                                </div>
                                <label for="input" class="col-sm-2 control-label">
                                    Name
                                </label>
                                <div class="col-sm-4">
                                    <input type="text" name="name_en" placeholder="Name" id="input" class="form-control"  required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <textarea name="desc_th" id="input" class="form-control" rows="5" placeholder="ราบละเอียด..." required="required"></textarea>
                                </div>
                                <label for="input" class="col-sm-2 control-label">
                                    Description
                                </label>
                                <div class="col-sm-4">
                                    ...
                                    <textarea name="desc_en" id="input" class="form-control" rows="5" placeholder="Description..." required="required"></textarea>
                                </div>
                            </div>
