                    ...
                    <div class="panel-body">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <input type="text" class="form-control" name="full_name" id="full_name" placeholder="ชื่อ - นามสกุล" value="{{ empty(old('full_name')) ? $order->full_name : old('full_name') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-1 mb-3">
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <select class="form-control" name="member_id" id="selectMember">
                                                    ...
                                                    @foreach($members as $member)
                                                        <option value="{{ $member->id }}" @if($order->member_id == $member->id || old('member_id') == $member->id) selected="selected" @endif>{{ $member->full_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <select class="form-control" name="shipping_method_id" required>
                                                    ...
                                                    @foreach($shippingMethod as $item)
                                                        <option value="{{ $item->id }}" @if(old('shipping_method_id') == $item->id || $order->shipping_method_id == $item->id) selected="selected" @endif>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-9">
                                                <input type="text" class="form-control" name="tracking" id="tracking" placeholder="Tracking" value="{{ (!empty($order->tracking->logistic_tracking_number)) ? $order->tracking->logistic_tracking_number : old('tracking') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-10">
                                                <div class="address">
                                                    <input type="hidden" name="shipping_address_line_1" id="shippingAddressLineOne" value="{{ empty(old('shipping_address_line_1')) ? $order->shipping_address_line_1 : old('shipping_address_line_1') }}">
                                                    <input type="hidden" name="shipping_address_line_2" id="shippingAddressLineTwo" value="{{ empty(old('shipping_address_line_2')) ? $order->shipping_address_line_2 : old('shipping_address_line_2') }}">
                                                    <input type="hidden" name="shipping_sub_district_id" id="shippingSubDistrict" value="{{ empty(old('shipping_sub_district_id')) ? $order->shipping_sub_district_id : old('shipping_sub_district_id') }}">
                                                    <input type="hidden" name="shipping_district_id" id="shippingDistrict" value="{{ empty(old('shipping_district_id')) ? $order->shipping_district_id : old('shipping_district_id') }}">
                                                    <input type="hidden" name="shipping_province_id" id="shippingProvince" value="{{ empty(old('shipping_province_id')) ? $order->shipping_province_id : old('shipping_province_id') }}">
                                                    <input type="hidden" name="shipping_postcode_id" id="shippingPostalCode" value="{{ empty(old('shipping_postcode_id')) ? $order->shipping_postcode_id : old('shipping_postcode_id') }}">
                                                    <div id="shippingAddressArea">
                                                        <div class="row pb-15">
                                                            <textarea class="address__block form-control" disabled>{{ $order->shipping_address_line_1 }} {{ $order->shipping_address_line_2 }} {{ $order->shippingSubDistrict->name }} {{ $order->shippingDistrict->name }} {{ $order->shippingProvince->name }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-10">
                                                <div class="address">
                                                    <input type="hidden" name="billing_address_line_1" id="billingAddressLineOne" value="{{ empty(old('billing_address_line_1')) ? $order->billing_address_line_1 : old('billing_address_line_1') }}">
                                                    <input type="hidden" name="billing_address_line_2" id="billingAddressLineTwo" value="{{ empty(old('billing_address_line_2')) ? $order->billing_address_line_2 : old('billing_address_line_2') }}">
                                                    <input type="hidden" name="billing_sub_district_id" id="billingSubDistrict" value="{{ empty(old('billing_sub_district_id')) ? $order->billing_sub_district_id : old('billing_sub_district_id') }}">
                                                    <input type="hidden" name="billing_district_id" id="billingDistrict" value="{{ empty(old('billing_district_id')) ? $order->billing_district_id : old('billing_district_id') }}">
                                                    <input type="hidden" name="billing_province_id" id="billingProvince" value="{{ empty(old('billing_province_id')) ? $order->billing_province_id : old('billing_province_id') }}">
                                                    <input type="hidden" name="billing_postcode_id" id="billingPostalCode" value="{{ empty(old('billing_postcode_id')) ? $order->billing_postcode_id : old('billing_postcode_id') }}">
                                                    <div id="billingAddressArea">
                                                        <div class="row pb-15">
                                                            <textarea class="address__block form-control" disabled>{{ $order->billing_address_line_1 }} {{ $order->billing_address_line_2 }} {{ $order->billingSubDistrict->name }} {{ $order->billingDistrict->name }} {{ $order->billingProvince->name }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xs-12 col-md-9">
                                                <textarea class="form-control" name="description" placeholder="รายละเอียด">{{ empty(old('description')) ? $order->description : old('description') }}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-md-9">
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    @foreach($orderStatus as $item)
                                                        <option value="{{ $item['key'] }}" @if($order->status == $item['key'] || old('status') == $item['key']) selected="selected" @endif>{{ $item['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12 col-md-9">
                                                <select name="payment_method" class="form-control">
                                                    ...
                                                    @foreach($paymentMethod as $item)
                                                        <option value="{{ $item['key'] }}" @if(old('payment_method') == $item['key'] || $order->payment_method == $item['key']) selected="selected" @endif>{{ $item['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                                ...
                                                                <li class="item">
                                                                    <a href="javascript:void(0)">
                                                                        <div class="item-image">
                                                                            <img class="img-responsive" src="{{ getImage($item->product->imageCover->image) }}" alt="" />
                                                                        </div>
                                                            ...
                                                            <div class="col-xs-12">
                                                                <div class="calculate text-right">
                                                                    ...
                                                                    <div class="calculate__price text-grey">
                                                                        ...
                                                                        <span id="price_before_discount">{{ number_format($order->price_before_discount, 2) }}</span> บาท
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12">
                                                                <div class="calculate text-right">
                                                                    ...
                                                                    <div class="calculate__price text-grey">
                                                                        ...
                                                                        <span id="discount">{{ number_format($order->discount, 2) }}</span> บาท
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12">
                                                                <div class="calculate text-right">
                                                                    ...
                                                                    <div class="calculate__price text-grey">
                                                                        ...
                                                                        <span id="shipping_free">{{ number_format($order->shipping_free, 2) }}</span> บาท
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-xs-12">
                                                                <div class="calculate calculate--total text-right">
                                                                    ...
                                                                    <div class="calculate__price text-red">
                                                                        ...
                                                                        <span id="total_price">{{ number_format($order->total_price, 2) }}</span> บาท
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-center mt-3">
                                ...
                                <a href="{{ route('backOffice.order.index') }}" class="btn btn-secondary btn-md">Cancel</a>
...
@section('script')
    ...
    <script src="{{ asset('js/backOffice/order/update.js') }}"></script>
