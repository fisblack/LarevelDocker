                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading--action">
                        <div class="row">
                            <div class="col-xs-12">
                                <h4>
                                    <img src="{{asset('images/backOffice/preOrder/icon-heading.png')}}" alt="" />Order
                                </h4>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="records table-responsive">
                                    @foreach($orders as $order)
                                        @include('backOffice.order._partial.detail_order')
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-8 text-right">
                                ...
                                @if(request()->get('search'))
                                    {{ $orders->appends(['search' => request()->get('search')])->links('paginations.sensebook') }}
                                @else
                                    {{ $orders->links('paginations.sensebook') }}
                                @endif
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script src="{{ asset('js/backOffice/order/index.js') }}"></script>
