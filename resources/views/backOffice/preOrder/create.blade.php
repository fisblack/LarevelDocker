    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-md-11 pt-2">
                <form action="{{ route('backOffice.pre-order.store') }}" method="POST">
                {!! csrf_field() !!}
                <!-- START panel-->
                        ...
                        <div class="panel-body">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-4">
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-xs-12 col-sm-9">
                                                    <input type="text" class="form-control" name="full_name" id="full_name" placeholder="ชื่อ - นามสกุล" value="{{ old('full_name') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-10">
                                                    <div class="address">
                                                        <input type="hidden" name="shipping_address_line_1" id="shippingAddressLineOne">
                                                        <input type="hidden" name="shipping_address_line_2" id="shippingAddressLineTwo">
                                                        <input type="hidden" name="shipping_sub_district_id" id="shippingSubDistrict">
                                                        <input type="hidden" name="shipping_district_id" id="shippingDistrict">
                                                        <input type="hidden" name="shipping_province_id" id="shippingProvince">
                                                        <input type="hidden" name="shipping_postcode_id" id="shippingPostalCode">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-md-10">
                                                    <div class="address">
                                                        <input type="hidden" name="billing_address_line_1" value="{{ old('billing_address_line_1') }}" id="billingAddressLineOne">
                                                        <input type="hidden" name="billing_address_line_2" value="{{ old('billing_address_line_2') }}" id="billingAddressLineTwo">
                                                        <input type="hidden" name="billing_sub_district_id" value="{{ old('billing_sub_district_id') }}" id="billingSubDistrict">
                                                        <input type="hidden" name="billing_district_id" value="{{ old('billing_district_id') }}" id="billingDistrict">
                                                        <input type="hidden" name="billing_province_id" value="{{ old('billing_province_id') }}" id="billingProvince">
                                                        <input type="hidden" name="billing_postcode_id" value="{{ old('billing_postcode_id') }}" id="billingPostalCode">
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center mt-3">
                                    ...
                                    <a class="btn btn-secondary btn-md" href="{{ route('backOffice.pre-order.index') }}">Cancel</a>
