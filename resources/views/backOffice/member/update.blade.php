            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="box-header-white clearfix" style="">
                    <div class="header-left clearfix" style=" ">
                        ...
                        <a href="{{ route('backOffice.member.edit', $member->id) }}" class="title active">
                            / Edit
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12">
                <div class="box-result" style="">
                    <div class="row">
                        <div class="col-md-12 ">
                            <form action="{{ route('backOffice.member.update', $member->id) }}" method="POST" class="form-horizontal form-writers clearfix" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6 @if($errors->has('full_name')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="full_name" class="form-control" value="{{ (old('full_name')) ? old('full_name') : $member->full_name }}">
                                    ...
                                    <div class="form-group col-sm-6 @if($errors->has('email_readonly')) has-error @endif">
                                        <label for="input" class="col-sm-4 control-label two">
                                            Email
                                        </label>
                                        <div class="col-sm-8">
                                            <input type="email" name="email_readonly" class="form-control" value="{{ (old('email_readonly')) ? old('email_readonly') : $member->email }}" readonly>
                                            @if($errors->has('email_readonly'))
                                                <div class="has-error">
                                                    <label for="input" class="col-sm-9 control-label">
                                                        {{ $errors->first('email_readonly') }}
                                                    </label>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6 @if($errors->has('phone')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="phone" class="form-control" value="{{ (old('phone')) ? old('phone') : $member->phone }}">
                                            @if($errors->has('phone'))
                                                <div class="has-error">
                                                    <label for="input" class="col-sm-9 control-label">
                                                        {{ $errors->first('phone') }}
                                    ...
                                    <div class="form-group col-sm-6 @if($errors->has('type')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="type" class="form-control">
                                                <option value="member" {{ (old('type') == 'member') ? 'selected' : (($member->type == 'member') ? 'selected' : '') }}>Member</option>
                                                <option value="admin" {{ (old('type') == 'admin') ? 'selected' : (($member->type == 'admin') ? 'selected' : '') }}>Administrator</option>
                                            </select>
                                            @if($errors->has('type'))
                                                <div class="has-error">
                                                    <label for="input" class="col-sm-9 control-label">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6 @if($errors->has('dob')) has-error @endif">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group datetime">
                                                <input type="text" class="form-control" data-toggle="datepicker" name="dob" value="{{ (old('dob')) ? old('dob') : date('Y-m-d', strtotime($member->dateOfBirth->date . '-' . $member->dateOfBirth->month . '-' . $member->dateOfBirth->year)) }}">
                                                <span class="input-group-addon bg-white">
										            <img src="{{ asset('images/backOffice/member/time.png') }}" alt="">
										        </span>
                                            </div>
                                    ...
                                    <div class="form-group col-sm-6">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="wrap-pic-slide">
                                                <div class="pic-slide">
                                                    @if($member->image)
                                                        <img src="{{ getImage($member->image) }}" alt="" id="display-profile-picture" class="img-responsive">
                                                    @else
                                                        <img src="{{ getImage('images/backOffice/banner/banner-no-img.png') }}" id="display-profile-picture" class="img-responsive">
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
