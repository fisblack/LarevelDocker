      ...
      <div class="wrapper">
        <div class="panel panel-default panel-container">
          ...
          <div class="panel-body">
            <form action="{{ route('backOffice.pos.store') }}" method="post">
              {{ csrf_field() }}
              <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <div class="form-group @if($errors->has('member_id')) has-error @endif">
                            ...
                            <input type="text" class="form-control" placeholder="ค้นหา..." data-action="typeaheadMember">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7">
                          <div class="form-group @if($errors->has('points')) has-error @endif">
                            <input type="text" class="form-control reward" name="points" placeholder="จำนวนแต้ม" value="{{ (old('points')) ? old('points') : '' }}">
...
@section('script')
  ...
  <script src="{{ asset('js/backOffice/pos/create.js') }}"></script>
  <script>
