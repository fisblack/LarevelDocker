...
return [
    ...
    'private_key_pass' => env('2C2P_KEY_PASS'),
    'private_key_path' => env('2C2P_PRIVATE_KEY'),//storage_path('cert/private.pem'),
    'public_key_path'  => env('2C2P_PUBLIC_KEY'),//storage_path('cert/public.crt'),
